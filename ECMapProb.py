...
def main_program():
	...
	if( plot_flag == 1 and not np.isnan( data_cones ).any( ) ):
		if( source_dem == 1 or source_dem == 3 ):
			plot_deg( run_name , type_sim , Cities , polygon , lon1 , lon2 , lat1 , lat2 , step_lat_m , step_lon_m , matrix_lon , matrix_lat , lon_cen_vector , lat_cen_vector , height_vector , hl_vector , Topography , Topography_Sea , N , data_cones , matrix_compare , ang_cal_range , data_direction , string_compare , comparison_polygon , comparison_type , vertices_compare )
		else:
			plot_utm( run_name , type_sim , polygon , matrix_east , matrix_north , east_cor , north_cor , n_east , n_north , cellsize , east_cen_vector , north_cen_vector , height_vector , hl_vector , Topography , Topography_Sea , N , data_cones , matrix_compare , ang_cal_range , data_direction , string_compare , comparison_polygon , comparison_type , vertices_compare )
