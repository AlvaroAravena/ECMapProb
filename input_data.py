...
# Source of DEM (1 => SRTM 30 m / 2 => uploaded DEM. A default location is assumed for uploaded DEMS: input_DEM.asc, see example)
source_dem = 1
...
# lon_cen = longitude of the collapse position center
# lat_cen = latitude of the collapse position center
